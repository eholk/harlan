...
(grammar-transforms
  ...
  (typecheck (%inherits Module Ret-Stmt)
    ...
    (Expr
      ...
      (begin Stmt * Expr)
      (vector Type Expr +)
      (vector-r Type RegionVar Expr +)
      (vector-ref Type Expr Expr)
      (kernel Type (((Var Type) (Expr Type)) +) Expr)
      (kernel-r Type RegionVar (((Var Type) (Expr Type)) +) Expr)
  ...
  (expand-primitives
    ...
    (Expr
      ...
      (begin Stmt * Expr)
      (vector-ref Type Expr Expr)
      (kernel Type RegionVar (((Var Type) (Expr Type)) +) Expr)
      (length Expr)
      (int->float Expr)
  ...
  (make-kernel-dimensions-explicit
    ...
    (Expr
      ...
      (begin Stmt * Expr)
      (vector-ref Type Expr Expr)
      (kernel Type RegionVar Integer (Expr +)
              (((Var Type) (Expr Type) Integer) *) Expr)
      (kernel Type RegionVar Integer (((Var Type) (Expr Type) Integer) *) Expr)
      (length Expr)
      (int->float Expr)
      (make-vector Type RegionVar Expr)
      (vector Type RegionVar Expr +)
  ...
  (make-work-size-explicit
    ...
    (Expr
      ...
      (begin Stmt * Expr)
      (vector-ref Type Expr Expr)
      (kernel Type RegionVar (Expr +) (((Var Type) (Expr Type) Integer) *) Expr)
      (length Expr)
      (int->float Expr)
      (make-vector Type RegionVar Expr)
      (vector Type RegionVar Expr +)
  ...
  (lift-complex (%inherits Module Decl)
    ...
    (Stmt
      ...
      Ret-Stmt)
    (Lifted-Expr
      (make-vector Type RegionVar Triv)
      (vector Type RegionVar Triv +)
      Triv)
    (Triv
      (if Triv Triv Triv)
      (call Triv Triv *)
