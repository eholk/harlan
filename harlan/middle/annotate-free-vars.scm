...
(define-match annotate-stmt
  ...
  ((vector-set! ,t
     ,[annotate-expr -> e1 fv1*]
     ,[annotate-expr -> e2 fv2*]
     ,[annotate-expr -> e3 fv3*])
   (values `(vector-set! ,t ,e1 ,e2 ,e3)
     (union/var fv1* fv2* fv3*)))
...
(define-match annotate-expr
  ...
  ((int->float ,[i fv*])
   (values `(int->float ,i) fv*))
  ((length ,[e fv*])
   (values `(length ,e) fv*))
  ((addressof ,[e fv*])
   (values `(addressof ,e) fv*))
  ((deref ,[e fv*])
   (values `(deref ,e) fv*))
  ((c-expr ,t ,x)
   (values `(c-expr ,t ,x) `()))
  ((call ,[rator fv*] ,[rand* fv**] ...)
   (values
     ...
     (apply union/var fv* fv**)))
  ((vector ,t ,[e* fv**] ...)
   (values `(vector ,t . ,e*) (apply union/var fv**)))
  ((reduce ,t ,op ,[e fv*])
   (values `(reduce ,t ,op ,e) fv*))
  ((make-vector ,t ,[e fv*])
   (values `(make-vector ,t ,e) fv*))
  ((iota ,[e fv*])
   (values `(iota ,e) fv*))
