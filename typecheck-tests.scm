...
(test-unify 'let-vec-vec
  ...
  (let ((g1 (vector 'g1))
    ...
    `(module
       (fn main () (() -> int)
         (let ,g1 (vector int 4) (vector (int 1) (int 0) (int 0) (int 0)))
         (let ,g2 (vector int 4) (vector (int 0) (int 1) (int 0) (int 0)))
         (let ,g3 (vector int 4) (vector (int 0) (int 0) (int 1) (int 0)))
         (let ,g4 (vector int 4) (vector (int 0) (int 0) (int 0) (int 1)))
         (let ,g5 (vector (vector int 4) 4)
            (vector (var (vector int 4) ,g1)
                    (var (vector int 4) ,g2)
                    (var (vector int 4) ,g3)
                    (var (vector int 4) ,g4)))
         (let A (vector (vector int 4) 4) (var (vector (vector int 4) 4) ,g5))
         (return (vector-ref int (vector-ref (vector int 4) (var (vector (vector int 4) 4) A) (int 1)) (int 2)))))))
...
(test-unify 'nested-kernels
  ...
  (let ((g1 (vector 'g1))
    ...
    `(module
       (fn main () (() -> int)
         (let ,g1 (vector int 3) (vector (int 1) (int 2) (int 3)))
         (let ,g2 (vector int 3) (vector (int 4) (int 5) (int 6)))
         (let ,g3 (vector int 3) (vector (int 7) (int 8) (int 9)))
         (let ,g4 (vector int 3) (vector (int 10) (int 11) (int 12)))
         (let ,g5 (vector (vector int 3) 4)
           (vector (var (vector int 3) ,g1)
                   (var (vector int 3) ,g2)
                   (var (vector int 3) ,g3)
                   (var (vector int 3) ,g4)))
         (let Rows (vector (vector int 3) 4) (var (vector (vector int 3) 4) ,g5))
         (let ,g6 (vector int 4)
           (kernel (vector int 4)
             (((row (vector int 3)) ((var (vector (vector int 3) 4) Rows) (vector (vector int 3) 4))))
             (let ,g7 (vector int 3)
               (kernel (vector int 3)
                 (((x int) ((var (vector int 3) row) (vector int 3))))
                 (var int x)))
             (let ,g8 int (reduce int + (var (vector int 3) ,g7)))
             (var int ,g8)))
         (let ,g9 int (reduce int + (var (vector int 4) ,g6)))
  ...
  (let ((g1 (vector 'g1))
    ...
    `(module
       (fn main () (() -> int)
         ...
         (let ,g2 (vector int 3)
           (kernel (vector int 3)
             (((j int) ((var (vector int 3) ,g1) (vector int 3))))
             (var int j)))
         (let A (vector int 3) (var (vector int 3) ,g2))
         (return (int 0))))))

(test-unify 'simple-loop
  (typecheck
    (lift-vectors
      (returnify
       '(module
  ...
  (let ((g1 (vector 'g1)))
    `(module
       (fn main () (() -> int)
         (let ,g1 (vector int 3) (vector (int 1) (int 2) (int 3)))
         (let X (vector int 3) (var (vector int 3) ,g1))
         (for ((i int) (int 0) (int 3)) 
           (let x int (+ (vector-ref int (var (vector int 3) X) (var int i)) (int 1)))
           (vector-set! int (var (vector int 3) X) (var int i) (var int x)))
  ...
  (let ((g1 (vector 'g1))
    ...
    `(module
       (fn main () (() -> int)
         ...
         (let ,g3 (vector int 4) (vector (int 0) (int 0) (int 1) (int 0)))
         (let ,g4 (vector int 4) (vector (int 0) (int 0) (int 0) (int 1)))
         (let ,g5 (vector (vector int 4) 4) (vector (var (vector int 4) ,g1)
                                                    (var (vector int 4) ,g2)
                                                    (var (vector int 4) ,g3)
                                                    (var (vector int 4) ,g4)))
         (let A (vector (vector int 4) 4) (var (vector (vector int 4) 4) ,g5))
         (let ,g6 (vector int 4) (vector (int 1) (int 0) (int 0) (int 0)))
         (let ,g7 (vector int 4) (vector (int 0) (int 1) (int 0) (int 0)))
         (let ,g8 (vector int 4) (vector (int 0) (int 0) (int 1) (int 0)))
         (let ,g9 (vector int 4) (vector (int 0) (int 0) (int 0) (int 1)))
         (let ,g10 (vector (vector int 4) 4) (vector (var (vector int 4) ,g6)
                                                     (var (vector int 4) ,g7)
                                                     (var (vector int 4) ,g8)
                                                     (var (vector int 4) ,g9)))
         (let B (vector (vector int 4) 4) (var (vector (vector int 4) 4) ,g10))
         (let ,g11 (vector (vector int 4) 4)
           (kernel (vector (vector int 4) 4)
             (((j int) ((iota (int 4)) (vector int 4))))
             (let ,g12 (vector int 4)
               (kernel (vector int 4)
                 (((i int) ((iota (int 4)) (vector int 4))))
                 (vector-ref int
                   (vector-ref (vector int 4)
                     (var (vector (vector int 4) 4) B) (var int j)) (var int i))))
             (var (vector int 4) ,g12)))
         (let Bt (vector (vector int 4) 4) (var (vector (vector int 4) 4) ,g11))
         (let ,g13 (vector (vector int 4) 4)
           (kernel (vector (vector int 4) 4)
             (((row (vector int 4)) ((var (vector (vector int 4) 4) A) (vector (vector int 4) 4))))
             (let ,g14 (vector int 4)
               (kernel (vector int 4)
                 (((col (vector int 4)) ((var (vector (vector int 4) 4) Bt) (vector (vector int 4) 4))))
                 (let ,g15 (vector int 4)
                   (kernel (vector int 4)
                     (((x int) ((var (vector int 4) row) (vector int 4))) ((y int) ((var (vector int 4) col) (vector int 4))))
                     (* (var int x) (var int y))))
                 (let ,g16 int (reduce int + (var (vector int 4) ,g15)))
                 (var int ,g16)))
             (var (vector int 4) ,g14)))
         (let C (vector (vector int 4) 4) (var (vector (vector int 4) 4) ,g13))
...
(test-unify 'annotate-smv
  ...
  (let ((g1 (vector 'g1))
    ...
    `(module
       (fn main () (() -> int)
         (let ,g1 (vector int 1) (vector (int 0)))
         (let ,g2 (vector int 1) (vector (int 1)))
         (let ,g3 (vector int 1) (vector (int 2)))
         (let ,g4 (vector int 1) (vector (int 3)))
         (let ,g5 (vector (vector int 1) 4) (vector (var (vector int 1) ,g1)
                                                    (var (vector int 1) ,g2)
                                                    (var (vector int 1) ,g3)
                                                    (var (vector int 1) ,g4)))
         (let Ai (vector (vector int 1) 4) (var (vector (vector int 1) 4) ,g5))
         (let ,g6 (vector int 1) (vector (int 1)))
         (let ,g7 (vector int 1) (vector (int 1)))
         (let ,g8 (vector int 1) (vector (int 1)))
         (let ,g9 (vector int 1) (vector (int 1)))
         (let ,g10 (vector (vector int 1) 4) (vector (var (vector int 1) ,g6)
                                                     (var (vector int 1) ,g7)
                                                     (var (vector int 1) ,g8)
                                                     (var (vector int 1) ,g9)))
         (let Av (vector (vector int 1) 4) (var (vector (vector int 1) 4) ,g10))
         (let ,g11 (vector int 4) (vector (int 1) (int 2) (int 3) (int 4)))
         (let X (vector int 4) (var (vector int 4) ,g11))
         (let ,g12 (vector int 4)
           (kernel (vector int 4)
             (((is (vector int 1)) ((var (vector (vector int 1) 4) Ai) (vector (vector int 1) 4)))
              ((vs (vector int 1)) ((var (vector (vector int 1) 4) Av) (vector (vector int 1) 4))))
             (let ,g13 (vector int 1)
               (kernel (vector int 1)
                 (((i int) ((var (vector int 1) is) (vector int 1)))
                  ((v int) ((var (vector int 1) vs) (vector int 1))))
                 (* (var int v) (vector-ref int (var (vector int 4) X) (var int i)))))
             (let ,g14 int (reduce int + (var (vector int 1) ,g13)))
             (var int ,g14)))
         (let Y (vector int 4) (var (vector int 4) ,g12))
         (assert (= (var (vector int 4) X) (var (vector int 4) Y)))
         (return (int 0))))))
  ...
  (let ((g1 (vector 'g1)))
    `(module 
       (fn main () (() -> int)
         (let ,g1 (vector int 3) (vector (int 1) (int 2) (int 3)))
	 (let X (vector int 3) (var (vector int 3) ,g1))
	 (for ((i int) (int 0) (length (var (vector int 3) X)))
	   (let x int (+ (vector-ref int (var (vector int 3) X) (var int i)) (int 1)))
	   (vector-set! int (var (vector int 3) X) (var int i) (var int x)))
	 (assert (= (vector-ref int (var (vector int 3) X) (int 0)) (int 2)))
	 (return (int 0))))))
  ...
  (let ((g1 (vector 'g1)))
    `(module 
       (fn main () (() -> int)
         ...
         (let X (vector int 3) (var (vector int 3) ,g1))
         (for ((i int) (int 0) (length (var (vector int 3) X)))
	   (vector-set! int (var (vector int 3) X) (var int i) (+ (vector-ref int (var (vector int 3) X) (var int i)) (int 1))))
	 (assert (= (vector-ref int (var (vector int 3) X) (int 0)) (int 2)))
	 (return (int 0))))))
...
(test-error 'dmm-2
  ...
  (fn main ()
      ...
      (let Bt (make-vector 4))
      (for (j 0 4)
        (let row (kernel ((i (iota 4)))
                         (vector-ref (vector-ref B (var j)) (var i))))
        (vector-set! (var Bt) (var j) (var row)))

      (let C (make-vector 4))
      (for (i 0 4)
        (let C-row (make-vector 4))
